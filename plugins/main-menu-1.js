...
conn.send3ButtonDoc(m.chat, `\n\n     *『 ɪ ɴ ᴛ ʀ ᴏ ᴄ ᴀ ᴅ ᴜ ᴛ ɪ ᴏ ɴ 』*\n\n`, intro + `\n\n${tag}\n\n`, 'AllMenu', '.? all', 'ListMenu', '.tesm', '\nArull,,,I LOVE YOU😭', 'bilek', m, { contextInfo: { forwardingScore: fsizedoc, externalAdReply: { body: 'ArullBotz By Sahrull', containsAutoReply: true, mediaType: 1, mediaUrl: hwaifu.getRandom(),  renderLargerThumbnail: true, showAdAttribution: true, sourceId: 'ArullBotz', sourceType: 'PDF', previewType: 'PDF', sourceUrl: sgc, thumbnail: fs.readFileSync('./thumbnail.jpg'), thumbnailUrl: sgc, title: 'Kalo Ga Ngerti Gosah Banyak Bacot Kids'}}})
    } 
